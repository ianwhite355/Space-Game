...
// In this file most of my changes were to mobidy the enemy to change to those missiles instead
// and Also to correct it so it looks good and makes more sense in its format
...
class Enemy {
  ...
  constructor(theRoot, enemySpot) {
    ...
    //this was for the new image and really just some random styling to make it perfect
